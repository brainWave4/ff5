...
; c0/fa9d: menu text ???
;                                        00 D7 35
; 00 D7 35 FF FF C5 FF FF FF CE FF FF FF 00 DA DC
; FF FF FF FF FF CE 00 DB DC FF FF FF FF FF CE 00
; 36 C2 24 00 8A 22 A8 84 C6 00 8A 8C 84 A0 00 9D
; 69 89 00 7D 89 23 00 78 84 C5 7E 78 00 72 B8 64
; C6 2E 00 7A C5 24 00 DF 28 DB D9 00 FF FF CF FF
; FF 00 2C AA 00 7F 8D 71 8D 00 83 6B 89 00 91 29
; 8F 7F 00 7D 89 23 6B 9B 89 00 D7 D9 35 D9 D7 00
; 73 AD 61 00 9B 8A 22 A8 84 C6 45 79 00 CE 00 75
; 8D 6D C3 89 00 79 27 85 00 61 39 79 00 9F 2D 85
; FF 00 63 3F A9 85 00 A9 C3 89 85 00 8B 7F 9D 00
; 6B A7 3F 00 8A 6E 7A 74 A8 00 81 6B A7 00 79 21
; B1 75 00 7F 8D A9 C3 6F 00 9D A9 C3 6F 00 73 89
; 31 6D 00 29 89 2D C3 00 6B 8D 63 A9 83 00 9B 91
; A5 75 00 C7 00 CD 00 31 B9 35 8D 9B 71 8D 71 B9
; 81 00 83 2D 9B AC 26 AA 9D 45 FF 8B 87 00 93 A5
; 9B 00 00 9B 6B 39 00 CF 00 AC 26 AA 00 D0 8D A7
; BD 77 BF 8D C9 FF 47 B9 93 33 B5 89 71 B9 45 CB
; D1 00 6B 89 00 89 AB 00 45 AB 00 85 A5 81 00 77
; 85 8D AB 6B 39 00 A5 BD 85 00 D0 93 95 2B FF 69
; 77 8D B9 3F 8D BD C9 CB D1 00 D0 8D 6F 83 FF 69
; 77 8D B9 3F 8D BD C9 CB D1 00 D0 C7 C7 91 6B 99
; 2B FF 7F A9 93 8D B5 89 3F 99 CB D1 00 D0 7D B9
; 93 95 FF B5 6F 21 BD 81 BF 3E A2 3F B5 C7 C7 D1
; 00 D0 A5 89 FF A5 BD 85 AB B9 45 77 C3 CB D1 00
; D0 9D 8D 47 FF 47 C5 A5 C9 D1 00 BB FF 7D 89 23
; 45 6D AB 36 C2 24 00 7B 8D 87 B9 00 3F 8D 37 93
; A5 9B 00 77 AF 00 6F AF 00 37 6F 89 00 77 C3 89
; 6B B9 00 8B 91 00 89 7F 00 77 C3 89 63 DB DC FF
; C7 FF FF FF 00 72 9C B8 46 00 AE C5 46 00 77 9D
; 77 7F 00 28 7E B8 00 A5 47 79 00 63 A7 2B 93 00
; 6A 7E 6A 92 00 91 B7 AB 00 71 B9 00 2E 2A 00 D0
; 93 95 BB 00 D0 8D 6F 83 00 FF 89 A9 7F 8D B9 3F
; 8D CB D1 00 3B B9 25 A5 BD 85 8D 6F 00 3B B9 3B
; B9 8D A7 93 8D 00 91 7F 6B A7 00 A5 81 A5 9B 00
; 24 2C 2F 33 38 00 94 C0 C5 30 C5 A0 00 20 86 AA
; A4 C5 46 FF FF FF FF FF 8A 6E 84 C6 48 FF FF 88
; CA 8C 86 00 72 B8 86 AE C5 A6 C5 9B B7 A9 65 A9
; 00 78 4B C5 46 00 A2 BC 7A C5 36 00 61 B1 8D FF
; FF FF FF FF 91 7D 8D 00 54 FF 55 FF 56 FF 57 FF
; 58 FF 59 00 72 9C B8 46 77 85 8D FF FF 88 C6 B8
; 46 88 FF FF 7F B9 77 C1 6F 00 30 C5 36 FF FF FF
; FF FF FF 90 B8 FF FF FF FF FF 90 64 00 74 88 B8
; 46 FF FF FF FF FF FF FF 78 84 AC 90 FF FF FF A4
; 9A A6 AA 00 72 B8 86 AE C5 A6 C5 54 FF 72 B8 86
; AE C5 A6 C5 55 00 6A C5 7C AA 8D 81 FF FF FF FF
; FF A5 47 79 FF FF FF FF 6D 91 6F 00 28 7E B8 9B
; 7B BD 85 8D 00 75 8D 7D 89 23 00 72 B8 86 AE C5
; A6 C5 FF FF FF FF 9A C5 9C AA FF FF FF 6A 78 7E
; A0 00 91 B7 A9 00 76 B8 2E AA FF FF FF 9C AA 80
; 00 88 C6 B8 46 88 6A A6 C5 00 31 00 26 00 21 00
; 0A 0C 0C 0C 0C 0C 0C 0C 0C 10 00 D0 91 9D 8F A7
; C9 D1 00 D0 7D 9B 9D 9D FF 89 33 6F 93 BD C9 C9
; D1 00 D3 00 D4 00 D5 00 D6 00 D7 00 D8 00 DD D9
; D7 D9 DE DF 00 71 BD 85 8D 81 C1 89 77 A2 94 C0
; C5 9C BC 4D FF 80 CA B8 36 29 89 2D C3 00 87 A7
; 8F 85 8D AB A4 B8 78 7E C5 00 7F B9 77 C1 6F 72
; 9C B8 46 9B 7B BD 85 8D 00 73 AD 45 00 61 37 A3
; 9D 79 6B CB 00 73 AD BB 71 77 85 00 6B 6D 73 B9
; 45 A5 00 8D 8D 45 79 6B CB 00 61 8D 00 8D 8D 8F
; 00 77 C1 89 A9 C3 89 00 8A 22 A8 84 C6 BB FF 83
; 71 85 6F 3F 75 8D 00 D0 75 8D 6D C3 89 7D 89 23
; D1 77 9D 79 00 7D 89 23 77 85 6F 3F 75 8D 00 7D
; 89 23 CF FF FF FF FF FF 00 D0 71 BD 85 8D D1 93
; 47 9B 7B BD 85 8D 2B FF 7D AD 3D AD 79 6F 93 6F
; 87 A5 00 63 87 83 43 83 61 8B AB B5 89 95 FF 81
; C3 89 7B 8D 77 85 6F 3F 75 8D 00